...
class AdminLinkActivityViewScreen extends StatefulWidget {
  Map id;

  AdminLinkActivityViewScreen({Key key, @required this.id}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _AdminLinkActivityViewState();
}

class _AdminLinkActivityViewState extends State<AdminLinkActivityViewScreen>
{
  Widget _picture;
  String firstname;
  String email;
