...
class ApiAdmin extends AppConstants {
  ...
  Future<Response<Map>> changeOrderStatus(var id, var status, comment) async {
    ...
    return await getInstance().post('changeEcommerceOrderStatus', data: params);
  }
  Future<Response<Map>> getLinkUserKonnectid( int linkuserid) async {
    Map params = Map<String, dynamic>();
    params['konnect_id'] = konnectId;
    params['sub_user_id'] = linkuserid;

    return await getInstance().post('getLinkUserKonnectid', data: params);
  }
  ...
  Future<Response<Map>> getkompassProActivityDetails(LinkuserID) async {
    ...
    return await getInstance()
        .post('getkompassProActivityDetails', data: params);
  }
  ...
  Future<Response<Map>> addLinkQuotation(Map params) async {


    return await getInstance().post('addQuotation', data: params);
  }
  Future<Response<Map>> deleteQuotation(Id) async {
    Map params = Map<String, dynamic>();
    params['id'] = Id;

    return await getInstance().post('deleteQuotation', data: params);
  }
  ...
  Future<Response<Map>> getSaleInvoice(String from,value) async {
    Map params = Map<String, dynamic>();
    params['konnect_id'] = konnectId;
    params['user_id'] = userId;
    params['from'] = from;
  ...
  Future<Response<Map>> getLedgerThrewGst(String id) async {
    return await getInstance()
        .post('getLedgerThrewGst', data: {'booking_id': id});
  }
  ...
  Future<Response<Map>> getSalesInvoiceThrewInvoiceNo(
      String Invoiceno, GstNo) async {
    Map params = Map<String, dynamic>();
    params['konnect_id'] = konnectId;
    ...
    return await getInstance()
        .post('getSalesInvoiceThrewInvoiceNo', data: params);
  }

  Future<Response<Map>> getPurchaseInvoiceThrewInvoiceNo(
      String Invoiceno, GstNo) async {
    Map params = Map<String, dynamic>();
    params['konnect_id'] = konnectId;
    params['invoice_no'] = Invoiceno;
    ...
    return await getInstance()
        .post('getPurchaseInvoiceThrewInvoiceNo', data: params);
  }
