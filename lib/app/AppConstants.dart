class AppConstants {
  ...
  static const String SHARE_APP = 'check out my app \n\n'
      'https://play.google.com/store/apps/details?id=com.geofarad.ommachinerystore';
  static const String SHARE_APPproduct = ' \n\n'
      'https://play.google.com/store/apps/details?id=com.geofarad.ommachinerystore';

  static const String SHARE_STORE = 'check out my online store \n\n'
      'https://meo.co.in/konnect-link/konnect-new/konnect-newlink.php?konnect_id=#product';
}
